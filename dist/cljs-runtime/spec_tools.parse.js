...
var fexpr__13808 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__13808.cljs$core$IFn$_invoke$arity$1 ? fexpr__13808.cljs$core$IFn$_invoke$arity$1(type) : fexpr__13808.call(null,type));
});
...
var G__13811 = spec_tools.impl.normalize_symbol(x);
var G__13812 = null;
var G__13813 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__13811,G__13812,G__13813) : spec_tools.parse.parse_form.call(null,G__13811,G__13812,G__13813));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__13814 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__13815 = x;
var G__13816 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__13814,G__13815,G__13816) : spec_tools.parse.parse_form.call(null,G__13814,G__13815,G__13816));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__13975 = cljs.spec.alpha.form(x);
var G__13976 = options;
x = G__13975;
options = G__13976;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__13826 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__13827 = null;
var G__13828 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__13826,G__13827,G__13828) : spec_tools.parse.parse_form.call(null,G__13826,G__13827,G__13828));
} else {
...
var G__13876 = parse_data;
var G__13876__$1 = (((G__13876 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__13876));
var G__13876__$2 = (((G__13876__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__13876__$1));
var G__13876__$3 = (((G__13876__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__13876__$2));
var G__13876__$4 = (((G__13876__$3 == null))?null:cljs.core.seq(G__13876__$3));
if((G__13876__$4 == null)){
return null;
} else {
return cljs.core.set(G__13876__$4);
}
}
});
...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__13879 = cljs.core.get_global_hierarchy;
return (fexpr__13879.cljs$core$IFn$_invoke$arity$0 ? fexpr__13879.cljs$core$IFn$_invoke$arity$0() : fexpr__13879.call(null));
})());
...
var map__13925 = spec_tools.impl.parse_keys(form);
var map__13925__$1 = cljs.core.__destructure_map(map__13925);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13925__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13925__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13925__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13925__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13925__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__13926 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__13926__$1 = (cljs.core.truth_((function (){var or__5045__auto__ = req;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13926,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__13926);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13926__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__13926__$1;
}
}));
...
var vec__13927 = multi_spec_form;
var seq__13928 = cljs.core.seq(vec__13927);
var first__13929 = cljs.core.first(seq__13928);
var seq__13928__$1 = cljs.core.next(seq__13928);
var _ = first__13929;
var first__13929__$1 = cljs.core.first(seq__13928__$1);
var seq__13928__$2 = cljs.core.next(seq__13928__$1);
var multi_method_symbol = first__13929__$1;
var ___$1 = seq__13928__$2;
var form = vec__13927;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__13938){
var vec__13939 = p__13938;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13939,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13939,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__13944_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__13944_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__13945_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__13945_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__13946_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__13946_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13947_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__13947_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__13950 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__13950__$1 = cljs.core.__destructure_map(map__13950);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13950__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__13951 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__13951__$1 = cljs.core.__destructure_map(map__13951);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13951__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__13952,options){
var vec__13953 = p__13952;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13953,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13953,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13953,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__13958,options){
...
var ___$1 = first__13961;
var values = seq__13960__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__13956_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__13956_SHARP_,options);
}),values);
...
var type_priority = (function (p1__13962_SHARP_){
var G__13965 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__13964 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__13962_SHARP_);
return (fexpr__13964.cljs$core$IFn$_invoke$arity$1 ? fexpr__13964.cljs$core$IFn$_invoke$arity$1(G__13965) : fexpr__13964.call(null,G__13965));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13963_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__13963_SHARP_,options);
}),cljs.core.rest(form))));
}));
