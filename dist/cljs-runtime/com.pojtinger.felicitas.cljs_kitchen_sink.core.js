...
reitit.frontend.easy.start_BANG_(reitit.frontend.router.cljs$core$IFn$_invoke$arity$2(com.pojtinger.felicitas.cljs_kitchen_sink.routes.routes,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"coercion","coercion",904067157),reitit.coercion.spec.coercion], null)], null)),(function (p1__15554_SHARP_){
return cljs.core.reset_BANG_(match,p1__15554_SHARP_);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.pojtinger.felicitas.cljs_kitchen_sink.components.wrapper,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(match),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"name","name",1843675177)], null)),(function (p1__15555_SHARP_){
return reitit.frontend.easy.push_state.cljs$core$IFn$_invoke$arity$1(p1__15555_SHARP_);
}),(cljs.core.truth_(cljs.core.deref(match))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(match),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.Keyword(null,"view","view",1247994814)], null))], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.pojtinger.felicitas.cljs_kitchen_sink.pages.not_found], null))], null);
})], null));
});
