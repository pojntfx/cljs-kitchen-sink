...
var G__12129 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__12129;
continue;
}
break;
...
var G__12003 = (function (){var G__12007 = rdr;
G__12007.cljs$tools$reader$reader_types$IPushbackReader$unread$arity$2(null,ch);

return G__12007;
})();
var G__12004 = ch;
var G__12005 = opts;
var G__12006 = pending_forms;
return (cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4(G__12003,G__12004,G__12005,G__12006) : cljs.tools.reader.read_tagged.call(null,G__12003,G__12004,G__12005,G__12006));
}
} else {
...
if(("\\" === ch__$1)){
var ch_12132__$2 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_12132__$2 == null)){
...
sb.append(ch_12132__$2);
} else {
}

var G__12133 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch__$1 = G__12133;
continue;
}
}
...
var vec__12010 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12010,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12010,(1),null);
...
var G__12139 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,form);
a = G__12139;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__12013 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__12014 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__12014);

try{return cljs.tools.reader.read_delimited_internal(kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__12013);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__12015 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12015,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12015,(1),null);
var the_list = cljs.tools.reader.read_delimited(new cljs.core.Keyword(null,"list","list",765357683),")",rdr,opts,pending_forms);
var vec__12018 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12018,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12018,(1),null);
...
var sb = (function (){var G__12033 = (new goog.string.StringBuffer());
G__12033.append(initch);
...
var G__12141 = (function (){var G__12034 = sb;
G__12034.append(ch);

return G__12034;
})();
var G__12142 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__12141;
ch = G__12142;
continue;
}
...
switch (G__12036) {
case "\\":
var G__12145 = (function (){var G__12037 = sb;
G__12037.append(cljs.tools.reader.escape_char(sb,reader));

return G__12037;
})();
var G__12146 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__12145;
ch = G__12146;
continue;
...
break;
default:
var G__12147 = (function (){var G__12038 = sb;
G__12038.append(ch);

return G__12038;
})();
var G__12148 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__12147;
ch = G__12148;
continue;
...
var vec__12039 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12039,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12039,(1),null);
...
var vec__12042 = cljs.tools.reader.starting_line_col_info(rdr);
...
var vec__12046 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12046,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12046,(1),null);
...
var vec__12051 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12051,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12051,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta((cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms)));
if(cljs.core.map_QMARK_(m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata(rdr,m);
...
var vec__12056 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12056,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12056,(1),null);
...
var G__12062 = rdr;
(cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__12062,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,G__12062,true,null,opts,pending_forms));
...
var G__12063 = sym;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__12063)){
return Number.NaN;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__12063)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__12063)){
...
var _STAR_suppress_read_STAR__orig_val__12064 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__12065 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__12065);

try{var form = (function (){var G__12066 = rdr;
var G__12067 = false;
var G__12068 = cljs.tools.reader.READ_EOF;
var G__12069 = ")";
var G__12070 = opts;
var G__12071 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__12066,G__12067,G__12068,G__12069,G__12070,G__12071) : cljs.tools.reader.read_STAR_.call(null,G__12066,G__12067,G__12068,G__12069,G__12070,G__12071));
})();
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__12064);
}});
...
var feature = (function (){var G__12072 = rdr;
var G__12073 = false;
...
var G__12078 = (function (){var G__12079 = rdr;
var G__12080 = false;
var G__12081 = cljs.tools.reader.READ_EOF;
var G__12082 = ")";
var G__12083 = opts;
var G__12084 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__12079,G__12080,G__12081,G__12082,G__12083,G__12084) : cljs.tools.reader.read_STAR_.call(null,G__12079,G__12080,G__12081,G__12082,G__12083,G__12084));
})();
cljs.tools.reader.check_eof_error(G__12078,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond(G__12078,rdr,first_line);
...
var G__12158 = matched;
var G__12159 = cljs.tools.reader.read_suppress(first_line,rdr,opts,pending_forms);
matched = G__12158;
finished = G__12159;
continue;
} else {
...
if(cljs.core.truth_(and__5043__auto__)){
var G__12087 = new cljs.core.Keyword(null,"read-cond","read-cond",1056899244).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__12086 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"preserve","preserve",1276846509),null,new cljs.core.Keyword(null,"allow","allow",-1857325745),null], null), null);
return (fexpr__12086.cljs$core$IFn$_invoke$arity$1 ? fexpr__12086.cljs$core$IFn$_invoke$arity$1(G__12087) : fexpr__12086.call(null,G__12087));
} else {
return and__5043__auto__;
}
})())){
...
var _STAR_suppress_read_STAR__orig_val__12088 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__12089 = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__12089);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__12088);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character(rdr);
}
...
var arg_env_orig_val__12090 = cljs.tools.reader.arg_env;
var arg_env_temp_val__12091 = cljs.core.sorted_map();
(cljs.tools.reader.arg_env = arg_env_temp_val__12091);

try{var form = (function (){var G__12092 = (function (){var G__12097 = rdr;
cljs.tools.reader.reader_types.unread(G__12097,"(");
...
var G__12094 = null;
var G__12095 = opts;
var G__12096 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__12092,G__12093,G__12094,G__12095,G__12096) : cljs.tools.reader.read_STAR_.call(null,G__12092,G__12093,G__12094,G__12095,G__12096));
})();
...
var G__12160 = (i + (1));
var G__12161 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(args,(function (){var or__5045__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__12090);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",ch)){
return cljs.tools.reader.wrapping_reader(new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null))((function (){var G__12098 = rdr;
G__12098.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var G__12162 = cljs.core.next(s__$1);
var G__12163 = ret;
s__$1 = G__12162;
r = G__12163;
continue;
...
var G__12164 = cljs.core.next(s);
var G__12165 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__12164;
key_vals = G__12165;
continue;
} else {
...
return (new cljs.core.List(null,new cljs.core.Symbol("cljs.core","with-meta","cljs.core/with-meta",749126446,null),(new cljs.core.List(null,ret,(new cljs.core.List(null,(function (){var G__12100 = cljs.core.meta(form);
return (cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1 ? cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1(G__12100) : cljs.tools.reader.syntax_quote_STAR_.call(null,G__12100));
...
var gensym_env_orig_val__12102 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__12103 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__12103);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__12102);
}});
...
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12104,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12104,(1),null);
...
var temp__5802__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(token,":"))?cljs.core.ns_name(cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(token)))?(function (){var G__12107 = token;
var G__12107__$1 = (((G__12107 == null))?null:cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__12107,(1)));
var G__12107__$2 = (((G__12107__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__12107__$1));
var G__12107__$3 = (((G__12107__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__12107__$2));
var G__12107__$4 = (((G__12107__$3 == null))?null:cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__12107__$3));
if((G__12107__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns(G__12107__$4);
}
})():(function (){var G__12108 = token;
var G__12108__$1 = (((G__12108 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__12108));
if((G__12108__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__12108__$1);
}
})()
));
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__12109 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12109,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12109,(1),null);
...
var G__12115 = tag;
var G__12116 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__12115,G__12116) : f.call(null,G__12115,G__12116));
} else {
...
}catch (e12119){if((e12119 instanceof Error)){
var e = e12119;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__12122,reader){
var map__12123 = p__12122;
var map__12123__$1 = cljs.core.__destructure_map(map__12123);
var opts = map__12123__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__12123__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
